...
class SubCategoryPresenter(
    ...
    private val view: MVPInterfaces.SubCategory.View
) : MVPInterfaces.SubCategory.Presenter {

    override fun fetchSubCategoriesById(categoryId: String) {
        volleyHandler.fetchSubCategory(
            categoryId,
            object : ResponseCallBack.FetchSubCategoryFromCategoryCallback {
